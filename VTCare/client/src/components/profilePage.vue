  ...
  methods: {
    ...
    save_dob: function () {
      if (this.editDateOfBirthVal === "") {
        ...
        this.editDateOfBirth = false;
        this.user.date = this.editDateOfBirthVal
      }
    },
    ...
    save_yoe: function () {
      if (this.editYoeVal === "") {
        ...
        this.editYoe = false;
        this.user.yearsOfExperience = this.editYoeVal
      }
    },
...
<template>
  <section class="profile-sec" v-if="this.$store.getters['UserModule/getUserType'] === 'Provider'">
